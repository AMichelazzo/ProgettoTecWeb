...
if(isset($_SESSION["username"]) && isset($_POST["old_password"])  && isset($_POST["new_password"]) && isset($_POST["new_password_repeat"]) && isset($_POST["cambia_password"]) && !$_SESSION["changeExec"]) {
    ...
    if(isset($result) && $result){
        if( $_POST["new_password"]!=$_POST["old_password"]){
            if($_POST["new_password"] == $_POST["new_password_repeat"]) {    
                ...
                $_SESSION["error_new_pass2"]="<img id=\"passNOT_combaciano\" src=\"img/Xrossa.png\" alt=\"Le due nuove <span lang=\en\">password</span> non sono uguali.
            ...
            $_SESSION["error_new_old2"]="<img id=\"passuguale\" src=\"img/Xrossa.png\" alt=\"La nuova <span lang=\en\">password</span> non può combaciare con quella nuova.
            \ height=\"15px\" width=\"15px\"/>"; 
            header("Location: profilo.php");
        }
    }
