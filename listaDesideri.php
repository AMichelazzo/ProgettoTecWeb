    ...
    if (isset($result)) {
        if (count($result) > 0) {
            for ($i = 0; $i < count($result); $i++) {
                ...
                $productlist .= "<label for=\"informazioni_prodotto-".$nome."\"></label>";
                $productlist .= "<input type=\"submit\" name=\"informazioni_prodotto-".$nome."\" value=\"Richiedi Informazioni\" />";
                $productlist .= "<label for=\"Scheda-Prodotto-".$nome."\"></label>";
