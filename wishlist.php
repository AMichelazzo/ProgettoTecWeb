    ...
    if(isset($result)){
        if(count($result)>0){
            for($i=0;$i<count($result);$i++){
                ...
                $productlist .= "<div class=\"categoria\">Categoria: ".$cat."</div>";
                $productlist .= "<div class=\"button-container\">";
                $productlist .= "<input type=\"submit\" name=\"informazioni\" value=\"Richiedi Informazioni\" />";
                $productlist .= "<button id=\"".$idprod."\" class=\"vaiProdotto\" name=\"vaiProdotto\">Scheda Prodotto -> </button>";
                ...
                $productlist .= "<img src=\"img/binClosed.png\" alt=\"Rimuovi prodotto dalla lista dei desideri.\" class=\"non-hover-image\" />";
